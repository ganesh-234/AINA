            ...
            >
              ...
              <div className="mt-8 p-6 bg-gradient-to-br from-orange-50 to-pink-50 dark:from-orange-900 dark:to-pink-900 rounded-xl">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-semibold text-lg">AI Chat At Your Pace</h3>
                </div>
                <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
                  Connect with the assistant any time for thoughtful responses and
                  guided conversation.
                </p>
                <motion.button
                  whileHover={{ scale: 1.02 }}
      ...
      <section className="py-12 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {[
              {
                question: "How does the assistant protect my privacy?",
                answer:
                  "Conversations are stored securely and only shared with your account. We focus on privacy and do not disclose your data to third parties.",
              },
              {
                question: "Is the assistant a replacement for therapy?",
                answer:
                  "This assistant is designed to provide emotional support and companionship, but it's not a replacement for professional therapy. We recommend seeking professional help for serious mental health concerns.",
              },
              {
