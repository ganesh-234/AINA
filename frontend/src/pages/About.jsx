...
const About = () => {
  ...
  const team = [
    {
      title: "AI Research",
      role: "Engineering & Model Design",
      bio: "Building the assistant with privacy-first, supportive conversational design.",
    },
    {
      title: "Clinical Guidance",
      role: "Mental Wellness Oversight",
      bio: "Ensuring our experience stays grounded in safe, compassionate support.",
    },
    {
      title: "Product & Experience",
      role: "Design & Growth",
      bio: "Crafting a calm, accessible interface for users seeking emotional wellbeing support.",
    },
  ];
      ...
      <section className="pt-20 pb-12 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            compassionate, and available whenever you need a listening space.
          </motion.p>
        </div>
      </section>
