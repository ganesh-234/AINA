...
const features = [
  ...
  },
  {
    ...
    desc: "Record voice messages and get AI responses with browser-based speech playback.",
    details: [
      "Speech-to-text input",
      "Browser text-to-speech",
      "Voice message capture",
      "Accessible voice interactions",
    ],
  },
  {
    icon: <FiLock className="w-6 h-6" />,
    title: "Secure & Private",
    desc: "Privacy-first design with secure authentication and user-controlled data.",
    details: [
  ...
  },
  {
    ...
    desc: "Save your chat sessions and revisit your conversations over time.",
    details: [
  ...
  },
  {
    ...
    desc: "Monitor your wellbeing with daily mood check-ins and conversation continuity.",
    details: [
      "Daily check-ins",
      "Mood patterns",
